...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.lars:
        ...
        raise NotImplementedError("I didn't bother downloading LARS since it looks not straightforawrd.")
        from apex.parallel.LARC import LARC
        optimizer = LARC(optimizer=optimizer, trust_coefficient=.001, clip=False)
    else:
        print("=> use standard SGD optimizer")
    ...
    if args.use_mnist:
        ...
        num_workers=args.workers, pin_memory=True)
    print("[DEBUG] Done dataloading, num train: {}, num val: {}".format(len(train_dataset), len(val_loader.dataset)))
    if args.distributed:
    ...
    if args.evaluate:
        ...
        return
    print("[DEBUGGING] Start training")
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        print("Loss: {}, Acc@1: {}, Acc@5: {}".format(losses.avg, top1.avg, top5.avg))
